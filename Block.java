...
public class Block
{
    ...
    public static void defineBlockSMP(int blockID, float hardness, float resistance, StepSound sound, int[] textureID, Material mat, String name) {
    	Block newBlock = new BlockVar(blockID, mat, textureID).setHardness(hardness).setResistance(resistance).setStepSound(sound).setBlockName(name);
